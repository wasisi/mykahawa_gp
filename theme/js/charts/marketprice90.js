$.getJSON('/marketprice90/?format=json', function(jsonfile){
...
var ctx = document.getElementById('marketprices90').getContext('2d');
var config = {
   type: 'line',
   data: {
      labels: labels,
   ...
   options: {
            ...
            title: {
               display: true,
               text: 'Min, Ave and Max Price (USD $ per 50 Kg bag) per Sale during the last 90 days'
            },
            tooltips: {
               mode: 'index',
               intersect: false,
