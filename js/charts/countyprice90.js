$.getJSON('/countyprice90/?format=json', function(jsonfile){
...
var ctx = document.getElementById('countyprices90').getContext('2d');
var config = {
   type: 'bar',
   data: {
      labels: labels,
   ...
   options: {
            ...
            title: {
               display: true,
               text: 'Min, Ave & Max Price (USD $ per 50 Kg bag) per county during the last 90 days'
            },
            tooltips: {
               mode: 'index',
               intersect: false,
